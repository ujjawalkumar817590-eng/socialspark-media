export default function socialsparkmedia() {
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      >
        <div>
          ...
          <h2 className="text-5xl md:text-7xl font-extrabold leading-tight mb-6">
            We Grow Brands <br />
            Through <span className="text-purple-400">Social Media</span>
          </h2>

          <p className="text-gray-400 text-lg leading-relaxed mb-8 max-w-xl">
            SocialSpark Media helps creators, startups, and businesses grow online with high-quality content, reels editing, Instagram management, and branding strategies.
          </p>
        ...
        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/10 border border-purple-500/20 rounded-3xl p-10 shadow-2xl">
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-gray-900 rounded-2xl p-6">
              <h3 className="text-4xl font-bold text-purple-400">150+</h3>
              <p className="text-gray-400 mt-2">Content Projects</p>
            </div>

            <div className="bg-gray-900 rounded-2xl p-6">
              <h3 className="text-4xl font-bold text-purple-400">10M+</h3>
              <p className="text-gray-400 mt-2">Monthly Reach</p>
            </div>

            <div className="bg-gray-900 rounded-2xl p-6">
              <h3 className="text-4xl font-bold text-purple-400">50+</h3>
              <p className="text-gray-400 mt-2">Brands Managed</p>
            </div>

            <div className="bg-gray-900 rounded-2xl p-6">
              <h3 className="text-4xl font-bold text-purple-400">24/7</h3>
              <p className="text-gray-400 mt-2">Support & Strategy</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Services */}
      <section id="services" className="px-8 py-24 bg-gray-950">
